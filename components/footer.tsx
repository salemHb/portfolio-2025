		...
		if (savedSettings) {
			try {
				...
				const newColorScheme =
					parsedSettings.colorScheme === "dark" ? "light" : "dark";
				...
				console.error(
					"Failed to parse theme settings from localStorage:",
					error
				);
						...
						<div>
							...
							<div className="flex items-center text-[#b4bcd0]">
								<span className="flex items-center">
									Made with{" "}
									<Heart
										className="w-4 h-4 text-[#ff6b6b] mx-1"
										fill="#ff6b6b"
									/>{" "}
									in Kenya
								</span>
