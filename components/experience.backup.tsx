...
export default function Experience() {
  ...
  return (
    <section id="experience" className="min-h-screen py-24 px-6 relative" ref={containerRef}>
      ...
      <div className="container w-full">
        ...
        <div className="flex flex-wrap justify-center mb-8 gap-2">
          <button
            ...
            style={activeTab === "current" ? { background: "linear-gradient(to right, var(--accent-primary), var(--accent-secondary))", color: "#0a0f1c", transform: "none" } : { transform: "none" }}
          >
          ...
          <button
            ...
            style={activeTab === "previous" ? { background: "linear-gradient(to right, var(--accent-primary), var(--accent-secondary))", color: "#0a0f1c", transform: "none" } : { transform: "none" }}
          >
          ...
          <button
            ...
            style={activeTab === "achievements" ? { background: "linear-gradient(to right, var(--accent-primary), var(--accent-secondary))", color: "#0a0f1c", transform: "none" } : { transform: "none" }}
          >
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {achievements.map((achievement, index) => (
                <div
                  key={achievement.id}
                  className={`glass-card p-4 sm:p-6 transform transition-all duration-1000 hover:border-[#00d4ff] hover:shadow-sm ${
                    isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
                  }`}
                  style={{
                    transitionDelay: `${0.4 + index * 0.1}s`,
