...
const projects: Project[] = [
	...
	{
		id: 2,
		title: "Portfolio 2025 – Personal Developer Showcase",
		tagline:
			"Modern, interactive portfolio with rich UX, customization, and responsive design",
		description:
			"A sleek developer portfolio built to demonstrate technical skills, projects, and career achievements with customizable UI and performance optimization.",
		longDescription:
			"Portfolio 2025 is a fully responsive and customizable personal portfolio website designed to present my skills, projects, and work experience in a compelling, interactive way. Developed with Next.js 14 and styled with Tailwind CSS, the site includes advanced theming options, accessibility support, dynamic content sections, and smooth animations to enhance user engagement. Visitors can explore projects, filter technologies, and switch between light/dark modes and accent themes, ensuring a personalized browsing experience.",
		technologies: [
			"Next.js 14",
			"Tailwind CSS",
			"React",
		...
		challenges: [
			"Building customizable UI without compromising performance",
			"Maintaining accessibility across custom animations and themes",
			"Creating modular, scalable content sections",
		],
		solutions: [
			"Implemented a theme panel with toggleable dark/light modes and accent colors",
			"Used Tailwind CSS with motion-reduced variants and high-contrast options",
			"Utilized Next.js App Router and dynamic routing for efficient content rendering",
		],
		features: [
			"Interactive hero and about sections",
			"Project filtering and dynamic displays",
			"Light/Dark mode with multiple themes",
			"Accessibility features: contrast, reduced motion",
			"Optimized for fast load time and animation smoothness",
			"Contact section with multiple communication methods",
		],
